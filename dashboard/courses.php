                    ...
                    <tbody>
                        ...
                        foreach($courses as $course){
                            if($course['status'] == 'pending'){
                                ...
                                echo "<tr class='border-b text-center border-spacing-10'>";
                                echo "<td class='p-1'><i class='fa-solid fa-circle-dot text-green-400'></i></td>";
                                echo "<td class='p-1'>" . $course['title'] . "</td>";
                                echo "<td class='p-1'>" . $course['username'] . "</td>";
                                echo "<td class='p-1'><a href='../viewEnseignant/detailsCourse.php?course_id=" . $course['course_id'] . "&type=" . $course['type'] . "' class='px-4 py-4 cursor-pointer bg-green-500 hover:bg-green-800 rounded-lg text-white'><b>Course link</b></a></td>";
                                echo "<td class='p-1'>" . $course['type'] . "</td>";
                                echo "<td class='p-2 flex justify-center gap-4'>";
                                echo "</td></tr>";
                            }
